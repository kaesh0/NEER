  ...
  return (
    <div className="relative min-h-screen bg-neer-navy-900 flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-8 lg:p-12 relative overflow-hidden bg-slate-50">
        ...
        <div className="w-full max-w-lg relative z-10 bg-white/90 backdrop-blur-md p-6 sm:p-8 rounded-2xl border border-neer-border shadow-neer-xl my-8">
          <button
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <LocationPicker
              ...
              label={t('Your coastal location')}
              value={location}
              onChange={(loc) => {
                setLocation(loc)
                setError('')
              }}
              placeholder={t('Search your coastal town or port…')}
              required
              hint={t('NEER shows sea conditions, zones and alerts for these waters.')}
            />
